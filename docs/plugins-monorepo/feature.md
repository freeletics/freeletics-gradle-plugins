...
```groovy
plugins {
    id("com.freeletics.gradle.feature").version("<latest-version>")
}
```

## Features enabled by default

- `useCompose()` is applied by default
- `enableAndroidResources()` is applied by default

## Default configurations

--8<-- "docs/defaults/base-1-configuration.md"
--8<-- "docs/defaults/base-2-default-dependencies.md"
--8<-- "docs/defaults/multiplatform-1-kotlin.md"
--8<-- "docs/defaults/multiplatform-android-1-config.md"
...
--8<-- "docs/features/multiplatform-1-targets.md"
--8<-- "docs/features/multiplatform-2-compose-resources.md"
--8<-- "docs/features/multiplatform-3-skie.md"
--8<-- "docs/features/multiplatform-android-1-paparazzi.md"
--8<-- "docs/features/multiplatform-android-2-parcelize.md)
--8<-- "docs/features/multiplatform-android-3-resources.md)
