...
## UNRELEASED
- Internal `applyPlatformConstraints` used by every plugin no longer use a deprecated
dependency notation that fails with Gradle 10.
...
## 0.36.6 *(2026-03-30)*
- Remove `-Xenhance-type-parameter-types-to-def-not-null` compiler flag. This flag is built into Kotlin 2.3.20.
